...
//        // Assuming a new method 'generateUniqueStrings' is implemented in the Faker class
//        Options options = new Options().withGenerateUniqueValues(true);
//        Set<String> uniqueStrings = Faker.generateUniqueStrings(100);
